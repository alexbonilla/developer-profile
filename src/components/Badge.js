        ...
        <div className="badge">
            <div className="card-content">
                <div className="content">
                    ...
                    <Image className="is-rounded has-text-centered" src={(badge.badge_template.image.url?badge.badge_template.image.url:"https://bulma.io/images/placeholders/64x64.png")} width="64" height="64" alt="alexbonilla"/>                    
                    {
